export const Projects = () => {
  return (
    <>
      <h2 className="text-3xl text-light-header dark:text-dark-header mb-3">Projects🧰</h2>
      <div className="flex flex-col gap-4">
        <div>
          <h3 className="text-xl text-light-header dark:text-dark-header mb-1">Social Media App</h3>
